...
if (path_speed > 0) {
	...
	var smoke_spawn_x = obj_train.x + lengthdir_x(smoke_offset_distance, obj_train.direction);
	var smoke_spawn_y = obj_train.y + lengthdir_y(smoke_offset_distance, obj_train.direction) - 30;
